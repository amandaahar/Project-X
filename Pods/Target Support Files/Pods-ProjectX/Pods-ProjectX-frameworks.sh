...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BLBubbleFilters/BLBubbleFilters.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MCFireworksButton/MCFireworksButton.framework"
