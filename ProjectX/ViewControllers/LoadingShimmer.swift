...
//  ProjectX
//
//  Created by amandahar on 8/9/19.
...
@objcMembers public class LoadHelper: NSObject {
    
    @objc public static let shared = LoadHelper()
    
    @objc private override init() {}
    
    @objc private var _viewCover: UIView?
    @objc private var viewCover: UIView? {
        if _viewCover == nil {
            _viewCover = UIView()
            _viewCover?.tag = 1024
    ...
    @objc private var colorLayer: CAGradientLayer?
    
    @objc private var maskLayer: CAShapeLayer?
    
    @objc private var coverablePath: UIBezierPath?
    @objc private var totalCoverablePath: UIBezierPath? {
    ...
    @objc private var addOffsetflag = false
    
    @objc public class func startCovering(_ view: UIView?) {
        shared.coverSubviews(view)
    }
    
    @objc public class func stopCovering(_ view: UIView?) {
        shared.removeSubviews(view)
        
    }
    
    
    @objc func removeSubviews(_ view: UIView?) {
        view?.viewWithTag(1024)?.removeFromSuperview()
    }
    
    @objc func coverSubviews(_ view: UIView?) {
    ...
    @objc func getTableViewPath(_ view: UIView?, index i: Int, coverableCellsIds: [Any]?) {
    ...
    @objc func addCover(_ view: UIView?) {
    ...
    @objc func getHeaderOffset() -> CGFloat {
    ...
    @objc func currentNavigationController() -> UINavigationController? {
